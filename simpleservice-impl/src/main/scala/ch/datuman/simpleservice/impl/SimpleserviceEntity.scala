...
/**
  * This is an event sourced entity. It has a state, [[SimpleserviceState]], which
  ...
  */
class SimpleserviceEntity extends PersistentEntity {

  override type Command = SimpleserviceCommand[_]
  override type Event = SimpleserviceEvent
  override type State = SimpleserviceState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: SimpleserviceState = SimpleserviceState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case SimpleserviceState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        SimpleserviceState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class SimpleserviceState(message: String, timestamp: String)

object SimpleserviceState {
  /**
    ...
    */
  implicit val format: Format[SimpleserviceState] = Json.format
}

/**
  * This interface defines all the events that the SimpleserviceEntity supports.
  */
sealed trait SimpleserviceEvent extends AggregateEvent[SimpleserviceEvent] {
  def aggregateTag = SimpleserviceEvent.Tag
}

object SimpleserviceEvent {
  val Tag = AggregateEventTag[SimpleserviceEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends SimpleserviceEvent
...
/**
  ...
  */
sealed trait SimpleserviceCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends SimpleserviceCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends SimpleserviceCommand[String]
...
object SimpleserviceSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    ...
    JsonSerializer[SimpleserviceState]
  )
}
